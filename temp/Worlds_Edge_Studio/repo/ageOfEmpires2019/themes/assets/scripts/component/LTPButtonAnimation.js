...
export default class LTPButtonAnimation {
    firstBuild() {
          let ltp_btn_point_animationPath = window.wp_object.ltp_btn_point_animationurl;
          let ltp_btn_magin_animationPath = window.wp_object.ltp_btn_magin_animationurl;
          let ltp_btn_magout_animationPath = window.wp_object.ltp_btn_magout_animationurl;
          let ltp_btn_prev_animationPath = window.wp_object.ltp_btn_prev_animationurl;
          let ltp_btn_next_animationPath = window.wp_object.ltp_btn_next_animationurl;
          let ltp_btn_minus_animationPath = window.wp_object.ltp_btn_minus_animationurl;
          let ltp_btn_plus_animationPath = window.wp_object.ltp_btn_plus_animationurl;


            $.getJSON( ltp_btn_point_animationPath, function( data ) {
              let anim_btns = $('body').find('.mobile_wrapper button.js-mapTrigger');
              let anim_labels = $('body').find('.js-pointsWrapper li');
