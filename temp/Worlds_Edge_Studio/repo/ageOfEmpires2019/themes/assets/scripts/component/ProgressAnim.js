...
export default class ProgressAnim {
  ...
  _animValue() {
    let self = this;
    let counter  = { value : 0 };
    let endCount = this.state.origPlayed;
    let count = '';
    ...
    if (this.options.isBar) {
      ...
      self.ui.container.addClass(this.options.circleClassPrefix + endCount);
    }
