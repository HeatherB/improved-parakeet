            ...
            <div class="survey_confirm survey_flex_container">
              ...
              <div class="status_section survey_flex_item">
                ...
                <div class="info_status">
                  <span class="info_label gamertag complete">{{$user->msa_gt}}</span>
                </div>
              </div>
              ...
              <div class="status_section survey_flex_item">
                ...
                <div class="info_status">
                  <span data-tooltip title="This action isn't required, but you won't be eligible to participate in betas. Don't worry, this information can be updated at a later time in your profile." class="info_label steam_id incomplete">Skipped</span>
                </div>
              </div>
            ...
            <div class="survey_questions_answered">
              <div class="status_section centered_full">
                ...
                <div class="survey_question_confirm" id="ssq_1">
                  <ul class="completion_list completion_confirmed text_links"></ul>
                </div>
              </div>
            </div>
