        ...
        <div class="row">
            <div class="frame-box">
                <div class="buy-now__default frame-box__inner frame-box__inner--dark">
                    ...
                    <div class="buy-now__footer clearfix use_featured_ft_height">
       ...
       <div class="row">
          <div class="frame-box">
             <div class="buy-now__default frame-box__inner frame-box__inner--dark">
                ...
                ?>
                    <span id="{{$anchor_identifier}}" class="jump_nav"></span>
                    <div class="frame-box" id="inter_inter">
                    <div class="buy-now__default frame-box__inner frame-box__inner--dark">
                        <div class="buy-now__game-title">
...
@forelse($defaults[0]['posts'] as $post)
@if(($post['headline'] != 'Age of Empires III: Definitive Edition') && ($post['headline'] != 'Age of Empires II: Definitive Edition') && ($post['headline'] != 'Pre-Order Now: Lords of the West'))
    <?php
        $anchor_create = str_replace(':','',$post['headline']);
        $anchor_identifier = str_replace(' ','_',$anchor_create);
    ?>
