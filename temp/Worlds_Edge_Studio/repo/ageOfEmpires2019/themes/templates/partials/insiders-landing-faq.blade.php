...
// If $signUpBlock['content_body_background_image'] exists and isn't default (like "Lords of the West" is selected from ACF drop-down)
// then add class for custom BG image (like for LOTW)
// elseif display "dynasties" class (default) near bottom of file for both items
if(
