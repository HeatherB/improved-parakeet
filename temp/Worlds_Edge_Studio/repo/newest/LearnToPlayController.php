            ...
            foreach($ltp_sections as $ltp_section) {
                if(!empty($ltp_section)) {
                    ...
                    if(!empty($ltp_section['content_group']['content_lesson'])) {
                        ...
                        $progress_headings_array[$ltp_section['content_group']['content_lesson']] = 0;
                        foreach($ltp_section['content_group'] as $content_point) {
                            $lesson_points = $ltp_section['content_group']['content_lesson'];
                            $progress_points_array[$lesson_points] = 0;
                        }
                    }
                    /* slide group */
