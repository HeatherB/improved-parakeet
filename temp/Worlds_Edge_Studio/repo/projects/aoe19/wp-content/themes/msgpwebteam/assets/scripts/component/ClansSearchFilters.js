...
export default class ClansSearchFilters {
  ...
  _getUrlParams(objParams) {
    ...
    if (objParams) {
      ...
      this.state.curSearchBy = objParams[this.options.apiPropNames.searchby];
      ...
      this.state.curSearchBy = this.constant.getUrlParam(this.options.apiPropNames.searchby, params);
  ...
  _setActiveStates() {
    ...
    this._setActiveFilter(this.ui.selectSearchBy, this.state.curSearchBy);
  ...
  _getFormElements() {
    ...
    this.ui.selectSearchBy  = this.ui.container.find('#' + [this.options.apiPropNames.searchby]);
    ...
    $.ajax({
      ...
      success: function(data){
        $.each(data,function(key,value){
          var sLanguage = '';
          var item = "<option value='" + value.utf8Language + "'>" + value.utf8Language + "</option>";
