...
class DataTypes
{
    ...
    public function register_post_types()
    {
        ...
        $data = array(
            'labels' => array(
                'name' => _x('Civilizations', 'post type general name'),
                ...
                'add_new' => _x('Add New Civilization', 'Game Mode'),
                'add_new_item' => __('Add New Civilization'),
                'new_item' => __('New Civilization'),
                'edit_item' => __('Edit Civilization'),
                'view_item' => __('View Civilization'),
                'all_items' => __('Civilizations'),
                'search_items' => __('Search Civilizations'),
                'parent_item_colon' => __('Parent Civilizations:'),
                'not_found' => __('No Civilizations found.'),
                'not_found_in_trash' => __('No Civilizations found in Trash.')
            ),
            'public' => true,
            'has_archive' => true,
            'publicly_queryable' => true,
            ...
            'show_ui' => true,
            'show_in_menu' => 'edit.php?post_type=games',
            'rewrite' => array('slug' => 'civilizations', 'with_front' => false),
            'supports' => array('title', 'author', 'comments', 'editor', 'thumbnail'),
            'show_in_rest' => true,
        );
        register_post_type('civilizations', $data);

        $data = array(
            'labels' => array(
                'name' => _x('Civ Archive Pages and Sub Menus', 'post type general name'),
                'singular_name' => _x('Civ Archive Page and Sub Menu', 'post type singular name'),
                'menu_name' => _x('Civ Archive Pages and Sub Menus', 'admin menu'),
                'name_admin_bar' => _x('Civ Archive Pages and Sub Menus', 'add new on admin bar'),
                'add_new' => _x('Add New Civ Archive Pages and Sub Menus', 'Game Mode'),
                'add_new_item' => __('Add New Civ Archive Page and Sub Menu'),
                'new_item' => __('New Civ Archive Page and Sub Menu'),
                'edit_item' => __('Edit Civ Archive Page and Sub Menu'),
                'view_item' => __('View Civ Archive Page and Sub Menu'),
                'all_items' => __('Civ Archive Pages and Sub Menus'),
                'search_items' => __('Search Civ Archive Pages and Sub Menus'),
                'parent_item_colon' => __('Parent Civ Archive Pages and Sub Menus:'),
                'not_found' => __('No Civ Archive Pages and Sub Menus found.'),
                'not_found_in_trash' => __('No Civ Archive Pages and Sub Menus found in Trash.')
            ),
            'public' => true,
            'has_archive' => true,
            'publicly_queryable' => true,
            ...
            'show_ui' => true,
            'show_in_menu' => 'edit.php?post_type=games',
            'rewrite' => array('slug' => 'civ_sub_menus', 'with_front' => false),
            'supports' => array('title', 'author', 'comments', 'editor', 'thumbnail'),
            'show_in_rest' => true,
        );
        register_post_type('civ_sub_menus', $data);      
    }
