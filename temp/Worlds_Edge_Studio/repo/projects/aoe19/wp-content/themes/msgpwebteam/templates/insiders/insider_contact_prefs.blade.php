            ...
            <div class="ac_content">
                ...
                <form id="contact_prefs">
                    ...
                    <label for="pref_email" class="survey-question-label">Preferred Email Address
                        <span data-tooltip tabindex="1" class="tooltip_icon"
                              title="This can be different from your Xbox Live email."></span>
                        <br/>
                        <input type="email" name="pref_email" id="pref_email" class="standard" value="{!!$pref_email!!}"/>
                    </label>

                    <label for="pref_country" class="survey-question-label">Country/Region<br/>
                        <select name="pref_country" id="pref_country" class="standard" data-country="{!!$country!!}"></select>
                    </label>
