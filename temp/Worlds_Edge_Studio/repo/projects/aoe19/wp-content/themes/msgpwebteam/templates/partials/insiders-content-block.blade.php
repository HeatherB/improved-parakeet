...
<div class="tease insider-content-block {{$sectionStyle}} {{$align}} {{$insider_status ? 'insider-community-70per-width' : ''}}">
    <div class="bg">
                    ...
                    <div class="buttons">
                        ...
                        @foreach ($content['buttons'] as $button)
                            ...
                            @if ($button['type'] != 'sign_in')
                                    {{-- <a class="btn-aoe--cta" href="{{$buttonHref}}">{{$button['button_text']}}</a> --}}
