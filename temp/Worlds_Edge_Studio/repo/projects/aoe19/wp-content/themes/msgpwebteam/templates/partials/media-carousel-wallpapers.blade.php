...
// set args for media wallpaper
$args = array(
        'post_type' => 'media_wallpaper',
        'post_status' => 'publish',
        'posts_per_page' => '-1',
        'meta_key' => 'media_wallpaper_game',
        'order' => 'DESC'
);
...
<div id="wallpapers" class="media section--divider-frank-mid section--padding background--rock">
    <div class="row">
        <main class="main">
                ...
                <div class="media-nav__container">
                    ...
                    <div id="media-carousel-wallpapers-nav">
                        ...
                        while ($query->have_posts()) : $query->the_post();
                            ...
                            $media_wallpaper_preview_image_size = 'medium'; // (thumbnail, medium, large, full or custom size)
                            $media_wallpaper_preview_image_size_url = $media_wallpaper_desktop_1920x1080['sizes'][$media_wallpaper_preview_image_size];
                            ...
                            echo('      <img class="wallpaper" data-lazy="'.$media_wallpaper_preview_image_size_url.'"/>');
                            echo('    </div>');
                            echo('  </div>');
                            echo('</div>');
