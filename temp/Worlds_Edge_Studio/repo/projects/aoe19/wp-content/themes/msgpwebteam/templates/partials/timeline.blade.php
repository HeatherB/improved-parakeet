<div class="timeline-container">
    <div class="scroll_container" style="display: none;">
    <div class="nav_container">

            <div class="top_timeline"></div>

            <div class="cultures" style="display: none;">
                <ul class="not_a_list">
								<?php
    ...
    <a href="#" class="timeline_button buttonshow"><img src="@asset('images/history/timeline/arrow.png')" />Show Timeline<img src="@asset('images/history/timeline/arrow.png')" /></a>
</div><!-- .container -->
