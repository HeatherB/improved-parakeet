...
class User{
    ...
    static public function updateUser($user_data) {
        ...
        if($id){
            ...
            // Searches D365 Adds ContactID and Sets Insider status
            if(class_exists('\Roots\Dynamics\Subscription',false)) {
            ...
            if (isset($user_data['OwnedGames']) && count($user_data['OwnedGames']) > 0) {
              update_user_meta($id, 'owned_games', $user_data['OwnedGames']);
            }
