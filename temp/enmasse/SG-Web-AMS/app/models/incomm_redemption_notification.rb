...
class IncommRedemptionNotification < LogAR
  ...
  def self.create_initial!(incomm_redemption, request)
    create!(
      :payment_method      => "incomm_redemption",
      :request_type        => "extend",
      :duration            => 30,
      :recurring           => false,
      :user_id             => incomm_redemption.user_id,
      :provider_txn_key    => incomm_redemption.id,
      :ext_product_id      => incomm_redemption.pin,
      :ext_user_id         => incomm_redemption.game_account_id,
