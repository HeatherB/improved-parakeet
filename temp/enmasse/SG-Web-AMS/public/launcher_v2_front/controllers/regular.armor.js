launcherApp.controller('regularArmorCtrl', ['$scope', '$state', 'systemManager', 'loginManager', 'patchManager', 'ngDialog',
  function ($scope, $state, systemManager, loginManager, patchManager, ngDialog) {
