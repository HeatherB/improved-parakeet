launcherApp.controller('regularZMRCtrl', ['$scope', "$http", "patchManager", "oauthManager", '$window', 'systemManager', "gameManager", "loginManager",
  function ($scope, $http, patchManager, oauthManager, $window, systemManager, gameManager, loginManager) {
    ...
    $scope.gameGameManager = gameManager.getGameWithName('zmr');
    $scope.gamePatchManager = patchManager.getGameWithName('zmr');      // this can be null for early stage games
