...
set :appdb, "kritika_website"	# will have env appended (e.g. web_ams_development) - see database.yml.sample
...
set :memcached_name, "kritika_website" # will have env appended (e.g. eme_ams_platform_development)
