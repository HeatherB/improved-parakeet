(function() {
	...
	var BambooHR = document.getElementById('BambooHR');

	if(BambooHR) {
		//add css file to dom so IE8 recognizes it
		document.write('<link href="https://enmasse.bamboohr.com/css/jobs-embed.css" rel="stylesheet" />');
		...
		var embedUrl = "https://enmasse.bamboohr.com/jobs/embed2.php";
