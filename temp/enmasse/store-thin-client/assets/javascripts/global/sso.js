;SSO = {
    ...
    loggedInButtons: function(){
        userBar = '<li class="emp"><span class="acct-emp">' + SSO.emp + '</span> EMP</li>';
        userBar += '<li class="logged_in_username">' + SSO.screenName + '<ul><li><a href="https://' + SSO.accountUrl + '">Account Settings</a></li><li><a href="#" id="eme-logout">Sign Out</a></li></ul></li>';
