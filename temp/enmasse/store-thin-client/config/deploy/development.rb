...
server 'localhost', user: "#{fetch(:deploy_user)}", roles: %w{app db}
...
set :memcached_servers, %w{"127.0.0.1:11211"} #NO COMMAS and MUST have quotes otherwise the colon messes up YAML
...
set :gifting_memcached_hosts, %w{"127.0.0.1:11211"}
...
set :tera_memcache_hosts, %w{"127.0.0.1:11211"}
...
set :subscription_memcached_hosts, %w{"127.0.0.1:11211"}
