  ...
  module Pages
    class MenuPresenter
      ...
      config_accessor :roots, :menu_tag, :list_tag, :list_item_tag, :css, :dom_id,
                      :max_depth, :selected_css, :first_css, :last_css, :top_level_list_tag_css,
                      :has_sub_menu_css, :is_sub_menu_css
      self.dom_id = 'menu'
      self.css = 'nine columns'
      self.menu_tag = :nav
      self.list_tag = :ul
      self.list_item_tag = :li
      self.selected_css = :selected
      self.top_level_list_tag_css = 'nav-bar'
      self.has_sub_menu_css = 'has-flyout'
      self.is_sub_menu_css = 'flyout'
      ...
      def render_menu_items(menu_items, top_level = false)
        if menu_items.present?
          content_tag(list_tag, :class => top_level ? top_level_list_tag_css : is_sub_menu_css ) do
      ...
      def render_menu_item(menu_item, index)
        content_tag(list_item_tag, :class => menu_item_css(menu_item, index), :id => menu_item.title.downcase.gsub(" ", "-")) do
      ...
      def menu_item_css(menu_item, index)
        ...
        css << has_sub_menu_css if menu_item.has_children?
