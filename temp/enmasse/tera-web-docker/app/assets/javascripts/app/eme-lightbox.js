...
$(document).on('click', '.emelightbox-pop .eme_slide', function() {
 ...
 if($('#emelightbox-wrapper img.eme_slide').length) {
    var loadedLB = $('#emelightbox-wrapper').find('img.eme_slide');
 } else {
    var loadedLB = $('#emelightbox-wrapper').find('.eme_slide img');
 }
  //var loadedLB = $('#emelightbox-wrapper').find('.eme_slide img') || $('#emelightbox-wrapper').find('img.eme_slide');
