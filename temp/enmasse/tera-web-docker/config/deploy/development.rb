...
server 'localhost', user: "#{fetch(:deploy_user)}", roles: %w{db app}
...
set :db_pool, "5"
set :db_hostname, "localhost" # Change back to localhost!
set :appdb, "teradocker_website"	# TODO: FILL IN - will have env appended (e.g. web_ams_development) - see database.yml.sample
...
set :memcached_servers, %w{127.0.0.1} #NO COMMAS and MUST have quotes otherwise the colon messes up YAML
