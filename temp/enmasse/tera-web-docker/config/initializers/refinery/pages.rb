...
Refinery::Pages.configure do |config|
  ...
  # Configure global page default parts
   config.default_parts = ["Article Header", "Body", "Side Body", "Wide Body", "Article Footer"]
  ...
  # config.auto_expand_admin_tree = true
   ...
   config.layout_template_whitelist = ["application","blank","jpblank"]
  ...
  # (https://github.com/flavorjones/loofah/blob/v2.0.3/lib/loofah/html5/whitelist.rb#L151)
   config.add_whitelist_elements = ["source", "track", "type", "src", "figure"]
  ...
  # (https://github.com/flavorjones/loofah/blob/v2.0.3/lib/loofah/html5/whitelist.rb#L152)
   config.add_whitelist_attributes = ["kind", "srclang", "placeholder", "controls", "required", "src", "autoplay"]
