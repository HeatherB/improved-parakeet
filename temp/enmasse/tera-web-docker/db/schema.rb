...
ActiveRecord::Schema.define(version: 20170922212317) do
  ...
  create_table "refinery_blog_post_translations", force: :cascade do |t|
    ...
    t.string   "slug",                  limit: 255
    t.string   "title",                 limit: 255
    t.text     "news_hero_field",       limit: 65535
    t.text     "teaser_img_field",      limit: 65535
  end
  ...
  create_table "refinery_blog_posts", force: :cascade do |t|
    ...
    t.string   "slug",              limit: 255
    t.integer  "teaser_image_id",   limit: 4
    t.integer  "news_hero_id",      limit: 4
    t.text     "teaser_field_code", limit: 65535
    t.text     "news_hero_field",   limit: 65535
    t.text     "teaser_img_field",  limit: 65535
  end
  ...
  create_table "refinery_pages", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.text     "top_of_head_code",    limit: 65535
    t.text     "news_hero_field",     limit: 65535
  end
  ...
  create_table "refinery_widgets", force: :cascade do |t|
    t.string   "name",       limit: 255
