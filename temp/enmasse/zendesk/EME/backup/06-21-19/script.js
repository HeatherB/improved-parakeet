...
/*  // Create a Twitch.Embed object that will render within the "twitch-embed" root element
 ...
 /* // provided video id youtube embed
  ...
  // capture category from breadcrumb
  if($('.breadcrumbs').length > 0) {
    var catName = $('.breadcrumbs li:nth-child(2)').attr('title');
    //console.log('catName ', catName);
    if (catName == 'TERA' || catName == 'Closers' || catName == 'Kritika') {
    ...
    if (catName == 'Stranger Things 3: The Game') {
      //console.log('here');
